...
no_dupes = [] # list with no dupes


filtered_list = [] #filtered list

# remove dupes gives you unique values
# for d in data:
...
# more_movies = ['Avengers', 'King Kong', 'TWD']
...
# while True:
#     user_input = input("Please enter your pets name: ").lower()

#     if user_input == 'stop':
#         break
#     elif user_input not in pets:
#         pets.append(user_input)
#         print(f'We have just added {user_input} to the pet list')
#         print(pets)
#     elif user_input in pets:
#         print(f'The name you typed in is already in the list')
#         print(pets)
#         continue
...
# no_dupes = []
# remove_dupes = list(set(remove_dupes))
...
for c in states:
    if c not in states_backup:
        states_backup.append(c)
print(states_backup)
print(states)
